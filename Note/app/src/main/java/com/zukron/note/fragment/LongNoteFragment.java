 ...
 * Created by Zukron Alviandy R on 8/11/2020
 */
public class LongNoteFragment extends Fragment {
    public static final String TAG = LongNoteFragment.class.getSimpleName();
    private static final String EXTRA_NOTE = "note";
    private TextInputEditText inputBodyNote, inputTitleNote;
    private Integer id = null;

    public LongNoteFragment() {
    }

    public static LongNoteFragment newInstance(Note note) {
        LongNoteFragment longNoteFragment = new LongNoteFragment();
        Bundle bundle = new Bundle();
        bundle.putParcelable(EXTRA_NOTE, note);

        longNoteFragment.setArguments(bundle);
